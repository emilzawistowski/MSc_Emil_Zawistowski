# Signal quality audit and ERP diagnostics, run on the *_epo.fif files from
# 01_preprocessing.py. Part 1 checks PSD/variance/GFP per epoch file; Part 2
# checks MMN/P3a polarity, SNR, and baseline per participant x block.
#
# Outputs: results/tables/quality_audit.csv, results/tables/erp_diagnostics.csv,
# results/reports/signal_diagnostics.txt
